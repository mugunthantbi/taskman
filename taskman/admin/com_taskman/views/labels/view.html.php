 ...
 * HelloWorlds View
 */
class TaskManViewLabels extends JViewLegacy
{
        /**
...
//                $this->setDocument();
        ...
        protected function addToolBar() 
        {
                ...
                JToolBarHelper::publish('labels.publish','JTOOLBAR_PUBLISH',true);
                JToolBarHelper::unpublish('labels.unpublish','JTOOLBAR_UNPUBLISH',true);
